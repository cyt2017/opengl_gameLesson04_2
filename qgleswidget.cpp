...
void QGLESWIDGET::render()
{
    ...
    _shader.begin();
    {
        ...
        Vertex  vect[]   =
        {
            CELL::float2(x,y),         CELL::float2(0,0),CELL::Rgba4Byte(255,0,0,255),
            CELL::float2(x + w,y),     CELL::float2(1,0),CELL::Rgba4Byte(0,255,0,255),
            CELL::float2(x,y + h),     CELL::float2(0,1),CELL::Rgba4Byte(0,0,255,255),
        ...
        glUniform1f(_shader._uvAnim,inc);
